...
if __name__ == '__main__':
    ...
    if start_over:
        ...
        m = keras.models.load_model(os.path.join(os.path.dirname(__file__), 'cnn_3x3_3layers_001lr_256_run3.h5'))
        print (m.summary())
        # print (m.get_layer('dropout_5'))
        m.optimizer = RMSprop(lr=0.00001)
        ...
        checkpoint_filepath = os.path.join(os.path.dirname(__file__), 'cnn_3x3_3layers_001lr_256_run4.h5')
