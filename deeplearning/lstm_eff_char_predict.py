...
with graph.as_default():
  ...
  def lstm_cell(i, o, state):
    ...
    all_gate = tf.matmul(i, X) + tf.matmul(o, M) + B
    # print (all_gate.shape)
    update = all_gate[:,num_nodes * 3:]
    other_gate = all_gate[:,0:num_nodes * 3]
    # print ('other gate', other_gate.shape)
